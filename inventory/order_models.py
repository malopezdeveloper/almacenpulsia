...
class ComponentReservation(models.Model):
 ...
 class Meta:constraints=[models.UniqueConstraint(fields=['component'],condition=models.Q(status__in=['active','installed','confirmed']),name='one_active_component_reservation')]
 def save(self,*a,**k):
