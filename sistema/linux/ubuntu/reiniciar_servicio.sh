...
systemctl list-unit-files "$SERVICE_NAME.service" >/dev/null 2>&1 || fail "El servicio $SERVICE_NAME no está instalado. Ejecute primero sistema/linux/ubuntu/instalar_todo.sh."
