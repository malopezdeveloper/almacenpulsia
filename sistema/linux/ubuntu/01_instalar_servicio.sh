...
[[ -f "$PROJECT_ROOT/manage.py" ]] || fail "No se encuentra manage.py en $PROJECT_ROOT. El instalador debe permanecer dentro de sistema/linux/ubuntu/."
...
case "${ID:-}" in
  ubuntu) ;;
  *) fail "Este instalador pertenece a sistema/linux/ubuntu y solo debe ejecutarse en Ubuntu Server/LTS. Sistema detectado: ${PRETTY_NAME:-${ID:-desconocida}}." ;;
esac
