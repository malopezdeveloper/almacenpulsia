...
. /etc/os-release
[[ "${ID:-}" == "debian" ]] || fail "Use este script únicamente en Debian 13 (Trixie). Detectado: ${PRETTY_NAME:-desconocido}"
[[ "${VERSION_ID%%.*}" -eq 13 ]] || fail "Esta rama está preparada para Debian 13 (Trixie)."
